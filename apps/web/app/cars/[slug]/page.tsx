                  ...
                  >
                    <Button 
                      className={`w-full font-bold text-lg py-4 shadow-lg transition-all duration-300 border-0 relative overflow-hidden group ${
                        areDatesSelected 
                          ? 'bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-black hover:shadow-2xl hover:shadow-amber-500/50 transform hover:scale-105' 
