              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-700 text-sm">
                    Our original pick-up location is located at Wilshire Boulevard, Los Angeles, CA. Airport and hotel delivery services are available 
              ...
              <Card className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{formatCurrency(carData.pricePerDay * calculateDays())} AED</span>
                  </div>
                  {bookingData.addOns.extraMileage && (
                    <div className="flex justify-between">
                      <span className="text-slate-600">Extra Mileage:</span>
                      <span className="font-medium">{formatCurrency(50 * calculateDays())} AED</span>
                    </div>
                  )}
                  {bookingData.addOns.childSeat && (
                    <div className="flex justify-between">
                      <span className="text-slate-600">Child Seat:</span>
                      <span className="font-medium">{formatCurrency(25 * calculateDays())} AED</span>
                    </div>
                  )}
                  {bookingData.addOns.chauffeur && (
                    <div className="flex justify-between">
                      <span className="text-slate-600">Chauffeur:</span>
                      <span className="font-medium">{formatCurrency(200 * calculateDays())} AED</span>
                    </div>
                  )}
                  <div className="border-t pt-3">
                    <div className="flex justify-between">
                      <span className="font-semibold text-slate-900">Total:</span>
                      <span className="font-bold text-primary text-lg">{formatCurrency(calculateTotal())} AED</span>
                    </div>
                  </div>
                </div>
              </Card>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 mt-2">
                  <span className="text-2xl font-bold text-primary">{formatCurrency(carData.pricePerDay)} AED</span>
