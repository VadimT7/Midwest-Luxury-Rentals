    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {/* Theatrical Spotlight Sweep - Dramatic & Cinematic */}
          <motion.div 
            className="absolute inset-0"
            animate={{
              background: [
                "radial-gradient(ellipse 1200px 600px at 0% 50%, rgba(251, 191, 36, 0.08) 0%, transparent 70%)",
                "radial-gradient(ellipse 1200px 600px at 30% 40%, rgba(251, 191, 36, 0.12) 0%, transparent 70%)",
                "radial-gradient(ellipse 1200px 600px at 50% 50%, rgba(251, 191, 36, 0.15) 0%, transparent 70%)",
                "radial-gradient(ellipse 1200px 600px at 70% 60%, rgba(251, 191, 36, 0.12) 0%, transparent 70%)",
                "radial-gradient(ellipse 1200px 600px at 100% 50%, rgba(251, 191, 36, 0.08) 0%, transparent 70%)",
                "radial-gradient(ellipse 1200px 600px at 70% 40%, rgba(251, 191, 36, 0.12) 0%, transparent 70%)",
                "radial-gradient(ellipse 1200px 600px at 50% 50%, rgba(251, 191, 36, 0.15) 0%, transparent 70%)",
                "radial-gradient(ellipse 1200px 600px at 30% 60%, rgba(251, 191, 36, 0.12) 0%, transparent 70%)",
                "radial-gradient(ellipse 1200px 600px at 0% 50%, rgba(251, 191, 36, 0.08) 0%, transparent 70%)"
              ]
            }}
          ...
          {/* Floating Luxury Particles - Theatrical & Elegant */}
          {[...Array(50)].map((_, i) => (
            <motion.div
              key={i}
          ...
          {/* Theatrical Stage Light Beams - Dramatic */}
          <motion.div 
            className="absolute inset-0 overflow-hidden"
            style={{ mixBlendMode: 'screen' }}
          >
            <motion.div
              className="absolute w-0.5 h-full bg-gradient-to-b from-transparent via-amber-400/12 to-transparent"
              style={{
                left: '15%',
          ...
          {/* Ambient Atmospheric Orbs - Subtle */}
          <motion.div
            className="absolute top-1/3 left-1/5 w-96 h-96 rounded-full"
            style={{
          ...
          />
          <motion.div
            className="absolute bottom-1/3 right-1/5 w-96 h-96 rounded-full"
            style={{
              background: 'radial-gradient(circle, rgba(251, 191, 36, 0.06) 0%, transparent 70%)',
              filter: 'blur(60px)'
            }}
          ...
          {/* Deep Theatrical Vignette */}
          <div className="absolute inset-0 bg-gradient-radial from-transparent via-black/40 to-black opacity-80" />
          
          {/* Dramatic Bottom Fade */}
          <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent opacity-70" />
          
          {/* Elegant Vertical Accent Lines - Dimmed */}
          <motion.div 
            className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-32 bg-gradient-to-b from-amber-400/30 via-amber-400/15 to-transparent"
          ...
          />
          <motion.div 
            className="absolute bottom-0 left-1/2 -translate-x-1/2 w-px h-32 bg-gradient-to-t from-amber-400/30 via-amber-400/15 to-transparent"
            style={{ boxShadow: '0 0 12px rgba(251, 191, 36, 0.2)' }}
            animate={{ 
              opacity: [0.3, 0.6, 0.3],
              scaleY: [0.9, 1.1, 0.9]
          ...
          {/* Refined Corner Frames - Theatrical */}
          <motion.div 
            className="absolute top-12 left-12 w-16 h-16 border-t border-l border-amber-400/25"
            style={{ boxShadow: '0 0 10px rgba(251, 191, 36, 0.15)' }}
            animate={{ 
              opacity: [0.3, 0.6, 0.3],
              scale: [1, 1.03, 1]
            }}
          ...
          />
          <motion.div 
            className="absolute top-12 right-12 w-16 h-16 border-t border-r border-amber-400/25"
            style={{ boxShadow: '0 0 10px rgba(251, 191, 36, 0.15)' }}
            animate={{ 
              opacity: [0.3, 0.6, 0.3],
              scale: [1, 1.03, 1]
          ...
          />
          <motion.div 
            className="absolute bottom-12 left-12 w-16 h-16 border-b border-l border-amber-400/25"
            style={{ boxShadow: '0 0 10px rgba(251, 191, 36, 0.15)' }}
            animate={{ 
              opacity: [0.3, 0.6, 0.3],
              scale: [1, 1.03, 1]
          ...
          />
          <motion.div 
            className="absolute bottom-12 right-12 w-16 h-16 border-b border-r border-amber-400/25"
            style={{ boxShadow: '0 0 10px rgba(251, 191, 36, 0.15)' }}
            animate={{ 
              opacity: [0.3, 0.6, 0.3],
              scale: [1, 1.03, 1]
            }}
            transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 3.75 }}
          />
        </div>
        ...
        <div className="container mx-auto px-6 py-4 md:py-8">
          ...
          >
            <div className="flex items-center justify-center gap-4 w-full">
              <div className="h-px w-8 md:w-12 bg-gradient-to-r from-transparent to-amber-400/60" />
              <span className="text-amber-300 text-sm font-light tracking-[0.3em] uppercase text-center whitespace-nowrap">
                Refine Your Selection
              </span>
              <div className="h-px w-8 md:w-12 bg-gradient-to-l from-transparent to-amber-400/60" />
            </div>
          </motion.div>
            ...
            >
              <div className="relative group">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-amber-400/10 via-amber-500/5 to-amber-400/10 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-all duration-500" />
                 ...
                 <div className="relative bg-black/80 backdrop-blur-md border border-amber-400/30 rounded-xl overflow-hidden group-hover:border-amber-400/50 transition-all duration-300">
                  ...
                  onChange={(e) => setSearchTerm(e.target.value)}
                    className="w-full pl-12 pr-4 py-3 md:py-4 bg-transparent text-white placeholder-neutral-400 focus:outline-none focus:placeholder-neutral-500 text-sm tracking-wide border-0"
                />
              </div>
            </div>
            </motion.div>
            ...
            >
              ...
              <select
                ...
                onChange={(e) => setSelectedCategory(e.target.value)}
                  className="relative bg-black/80 backdrop-blur-md border border-amber-400/30 text-white pl-4 md:pl-6 pr-10 md:pr-12 py-2 md:py-3 rounded-xl text-sm font-light tracking-wide cursor-pointer hover:border-amber-400/50 focus:border-amber-400/70 focus:outline-none transition-all duration-300 min-w-[160px] md:min-w-[200px] appearance-none"
              ...
              >
                ...
                <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 h-4 w-4 text-amber-400/70 pointer-events-none" />
              </div>
              ...
              <select
                ...
                onChange={(e) => setSelectedPriceRange(e.target.value)}
                  className="relative bg-black/80 backdrop-blur-md border border-amber-400/30 text-white pl-4 md:pl-6 pr-10 md:pr-12 py-2 md:py-3 rounded-xl text-sm font-light tracking-wide cursor-pointer hover:border-amber-400/50 focus:border-amber-400/70 focus:outline-none transition-all duration-300 min-w-[180px] md:min-w-[220px] appearance-none"
                  style={{ backgroundImage: 'none' }}
              >
