    ...
    <section className="section-spacing bg-black text-white overflow-hidden">
      <div className="container-luxury">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          {/* First Video - Mercedes CLE 53 AMG */}
          <motion.div
            ...
            <div className="relative aspect-[9/16] rounded-2xl overflow-hidden bg-slate-900">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">Mercedes-Benz CLE 53 AMG</p>
                    <p className="text-xs text-neutral-300">Performant Luxury</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Second Video - Mercedes AMG GT 45 */}
          <motion.div
            initial={{ opacity: 0, x: 100 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-300">When Practicality Meets Performance and Mercedes Luxury</p>
                  </div>
                </div>
              </div>
            </div>
