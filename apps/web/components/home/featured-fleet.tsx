    ...
    <div>
      ...
      >
        <Link href="/fleet">
          <Button 
            size="xl" 
            className="min-w-[280px] bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white shadow-luxury hover:shadow-luxury-hover border-0 px-8 py-4 text-lg font-semibold tracking-wide"
            shimmer
