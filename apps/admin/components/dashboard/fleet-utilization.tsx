    ...
    try {
      ...
      if (response.ok) {
        ...
        const vehiclesWithStats = data.map((vehicle: Vehicle) => ({
          ...
          utilizationDays: (vehicle as any).utilizationDays || 0,
    ...
    <div className="stat-card">
      <div className="mb-6">
        ...
        <p className="text-sm text-neutral-600 mt-1">
          Days rented in the last 30 days by vehicle
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          ...
          {activeVehicles
            .sort((a, b) => (b.utilizationDays || 0) - (a.utilizationDays || 0))
            .slice(0, 3)
            .map((item) => (
            <div key={item.id} className="space-y-1">
              ...
              <div className="text-xs text-neutral-500">
                {item.utilization || 0}% of last 30 days
              </div>
            </div>
          ))}
        </div>
