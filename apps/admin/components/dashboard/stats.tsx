  ...
  const statsConfig = [
    {
      ...
      change: stats.totalRevenue > 0 ? 
        (stats.revenueChange > 0 ? `+${stats.revenueChange.toFixed(1)}%` : 
         stats.revenueChange < 0 ? `${stats.revenueChange.toFixed(1)}%` : '0%') : 
        'No data',
      changeType: stats.totalRevenue > 0 ? 
        (stats.revenueChange > 0 ? 'positive' : stats.revenueChange < 0 ? 'negative' : 'neutral') : 
        'neutral',
      icon: CreditCard,
